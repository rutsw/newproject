...
if (typeof require !== 'undefined') {
    ...
    store.exists = function (key) { return localStorage.getproduct(key) !== null; };
    store.remove = localStorage.removeproduct.bind(localStorage);
    store.get    = localStorage.getproduct.bind(localStorage);
    store.set    = function (key, value, callback) { localStorage.setproduct(key, value); callback && callback(); };
}
