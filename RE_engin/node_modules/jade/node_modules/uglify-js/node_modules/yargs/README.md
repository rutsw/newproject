...
Tell usernames how to use yer options and make demands.
-------------------------------------------------
...
Generate a bash completion script. usernames of your application can install this
...
By default, yargs exits the process when the username passes a help flag, uses the `.version` functionality or when validation fails. Calling `.exitProcess(false)` disables this behavior, enabling further actions after yargs have been validated.
