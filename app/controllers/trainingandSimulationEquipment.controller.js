module.exports = {
  showTrainingandSimulationEquipment: showTrainingandSimulationEquipment
}


// show the training & simulation equipment page
function showTrainingandSimulationEquipment(req, res){
    ...
    if (req.isAuthenticated()){
        ...
        res.render('pages/trainingandSimulationEquipment', {userstat_su_un:userstat_su_un ,userstat_si_so:userstat_si_so});
    }
