module.exports = {
  showMedicalEquipment: showMedicalEquipment
}


// show the medical equipment page
function showMedicalEquipment(req, res){
    ...
    if (req.isAuthenticated()){
        ...
        res.render('pages/medicalEquipment', {userstat_su_un:userstat_su_un ,userstat_si_so:userstat_si_so});
    }
