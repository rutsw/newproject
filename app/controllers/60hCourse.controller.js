module.exports = {
  show60hCourse: show60hCourse
}


// show 60h course page
function show60hCourse(req, res){
    ...
    if (req.isAuthenticated()){
        ...
        res.render('pages/60hCourse', {userstat_su_un:userstat_su_un ,userstat_si_so:userstat_si_so});
    }
