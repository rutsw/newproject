module.exports = {
  show22hCourse: show22hCourse
}


 // show 22h course page
function show22hCourse(req, res){
    ...
    if (req.isAuthenticated()){
        ...
        res.render('pages/22hCourse', {userstat_su_un:userstat_su_un ,userstat_si_so:userstat_si_so});
    }
