module.exports = {
  showMedicalTeamsCourse: showMedicalTeamsCourse
}


// show the medical teams course page
function showMedicalTeamsCourse(req, res){
    ...
    if (req.isAuthenticated()){
        ...
        res.render('pages/medicalTeamsCourse', {userstat_su_un:userstat_su_un ,userstat_si_so:userstat_si_so});
    }
