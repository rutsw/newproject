module.exports = {
  showOnlineCourse: showOnlineCourse
}


// show the online course page
function showOnlineCourse(req, res){
    ...
    if (req.isAuthenticated()){
        ...
        res.render('pages/onlineCourse', {userstat_su_un:userstat_su_un ,userstat_si_so:userstat_si_so});
    }
