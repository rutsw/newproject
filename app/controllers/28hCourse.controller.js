module.exports = {
  show28hCourse: show28hCourse
}


// show 28h course page
function show28hCourse(req, res){
    ...
    if (req.isAuthenticated()){
        ...
        res.render('pages/28hCourse', {userstat_su_un:userstat_su_un ,userstat_si_so:userstat_si_so});
    }
