module.exports = {
  showParamedicCourse: showParamedicCourse
}


// show the paramedic course page
function showParamedicCourse(req, res){
    ...
    if (req.isAuthenticated()){
        ...
        res.render('pages/paramedicCourse', {userstat_su_un:userstat_su_un ,userstat_si_so:userstat_si_so});
    }
